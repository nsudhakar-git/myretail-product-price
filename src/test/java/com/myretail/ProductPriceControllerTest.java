...
public class ProductPriceControllerTest {
	...
	@Mock
	private ProductDAOImpl daoMock = new ProductDAOImpl();
	...
	/*
	 * @Test public void getProducts() throws Exception {
	 * mvc.perform(MockMvcRequestBuilders.get("/product").accept(MediaType.
	...
	public void getProduct() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.get("/product/1241")
				...
				.andExpect(jsonPath("$.price.amount",is(12)) );
	}
	@Test
